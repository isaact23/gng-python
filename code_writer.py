 ...
 * Re-running source generator will overwrite all changes.
 */

"""

ROUTINES_DIR = "Routines"
OUTPUT_DIR = "../gng-chunk-impl/Assets/Scripts/ClusterGeneration/SourceGen"
#OUTPUT_DIR = "Output"
...
class CodeWriter:
    def __init__(self, layer, file_name):
        ...
        if layer is not None:
            directory = os.path.join(directory, layer['pascal_prefix'])
